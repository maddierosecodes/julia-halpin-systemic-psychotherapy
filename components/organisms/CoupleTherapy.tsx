...
export default function CoupleTherapy() {
  return (
    ...
    >
      ...
      to reflect on what&apos;s happening in your relationship and explore what
      you&apos;d like to change.
      <br />
      <span className="emphasis-text-dark">Using a systemic approach</span>, we
      explore how patterns of communication and interaction have developed
      ...
      , and supporting you to navigate challenges with greater clarity and care.
    </ServiceLayout>
  );
}
