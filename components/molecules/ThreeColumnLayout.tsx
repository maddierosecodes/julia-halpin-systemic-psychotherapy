...
export const ThreeColumnLayout = ({
  ...
  return (
    <div className="grid grid-cols-1 mx-3 sm:mx-10 md:mx-0 md:grid-cols-2 lg:grid-cols-12 gap-8 md:gap-2 lg:gap-0 mt-10 sm:mt-28 md:mt-24 lg:pt-0 xl:mt-6 lg:relative lg:overflow-visible">
      {/* Decorative lines */}
      <div
        className="hidden lg:block absolute inset-0 w-full h-full mt-2 xl:mt-0 pointer-events-none"
        aria-hidden="true"
      >
        <div
          className="absolute left-[6%] right-0 w-[80%] bottom-[28%] xl:bottom-[32%]"
          aria-hidden="true"
        >
          <div
            className="relative w-full h-[4px] bg-gold-500"
            aria-hidden="true"
          />
        </div>
        <div
          className="absolute left-[12%] right-0 w-[80%] bottom-[2%] xl:bottom-[3%]"
          aria-hidden="true"
        >
          <div
            className="relative w-full h-[4px] bg-gold-500"
