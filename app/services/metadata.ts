...
export const metadata: Metadata = {
  title: 'Systemic Psychotherapy Services in Chorley | Family & Couple Therapy',
  description:
    'Explore professional therapy services in Chorley with Julia Halpin. Offering systemic psychotherapy for couples and families. Supervision and MSc student consultations available.',
  keywords: [
  ...
  openGraph: {
    title:
      'Systemic Psychotherapy Services in Chorley | Family & Couple Therapy',
    description:
      'Discover systemic psychotherapy services with Julia Halpin in Chorley. Sessions available for couples and families. Also offering supervision and MSc consultations.',
  ...
  twitter: {
    ...
    title:
      'Systemic Psychotherapy Services in Chorley | Family & Couple Therapy',
    description:
      'Learn more about systemic therapy services in Chorley with Julia Halpin. Couple and family sessions available, including professional supervision.',
    images: [
