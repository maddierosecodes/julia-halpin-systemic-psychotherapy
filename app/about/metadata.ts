...
export const metadata: Metadata = {
  ...
  twitter: {
    ...
    title: 'About Julia Halpin | Systemic Psychotherapist in Chorley',
    description:
      "Discover Julia Halpin's background in Systemic Psychotherapy. She supports families, and couples in Chorley and online, with over 30 years of mental health experience.",
    images: [
